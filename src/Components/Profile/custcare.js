        ...
        <div class="main-bd">
          ...
          <div class="right-side">
            ...
            <ul style={{width:'60vw'}}>
                ...
                <Link to ="/points"><li onclick="tabs(0)" class="user-post" style={{marginLeft:'20px',color:'black'}}>Points</li></Link>
                <Link to ="/useraddress"><li onclick="tabs(0)" class="user-post" style={{marginLeft:'20px',color:'black'}}>Address</li></Link>
                <Link to ="/cc"><li onclick="tabs(0)" class="user-post active" style={{marginLeft:'20px',color:'black'}}>Customer Care</li></Link>
              </ul>
            </div>
            <div class="profile-body">
              <div class="profile-posts-tab">
                <h1>Contact the Below Number</h1>
                <h3> +91-9999999999</h3>
              </div>
            </div>
          </div>
