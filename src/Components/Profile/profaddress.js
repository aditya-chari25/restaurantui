        ...
        <div class="main-bd">
          ...
          <div class="right-side">
            ...
            <ul style={{width:'60vw'}}>
                ...
                <Link to ="/useraddress"><li onclick="tabs(0)" class="user-post  active" style={{marginLeft:'20px',color:'black'}}>Address</li></Link>
